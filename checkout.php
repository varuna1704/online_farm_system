...
if(isset($_POST['order_btn'])){
   ...
   $detail_query = pg_query($conn, "INSERT INTO order(name,onumber,email,omethod,flat,street,city,state,country,pin_code,total_products,total_price) VALUES('$name','$number','$email','$method','$flat','$street','$city','$state','$country','$pin_code','$total_product','$price_total')") or die('query failed');
...
?>
      <?php
         $select_cart = pg_query($conn, "SELECT * FROM cart");
         $total = 0;
         $grand_total = 0;
